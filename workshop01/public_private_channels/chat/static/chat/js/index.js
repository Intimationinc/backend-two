...
const createNewRoomModalBackdrop = document.querySelector("#create-new-room-modal-backdrop")
...
const joinPublicRoomModalBackdrop = document.querySelector("#join-public-room-modal-backdrop")

...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=regain001.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x31, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x22, 0xa5, 0x02, 0x0a, 0x06, 0x53, 0x63, 0x72,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x72, 0x65, 0x67, 0x61, 0x69, 0x6e, 0x30, 0x30, 0x31,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1e, 0x2e, 0x72, 0x65, 0x67, 0x61, 0x69, 0x6e, 0x30, 0x30, 0x31,
...
var file_screen_message_proto_goTypes = []any{
	(Screen_Panel)(0),         // 0: regain001.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: regain001.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: regain001.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: regain001.pcbook.Screen.resolution:type_name -> regain001.pcbook.Screen.Resolution
	0, // 1: regain001.pcbook.Screen.panel:type_name -> regain001.pcbook.Screen.Panel
